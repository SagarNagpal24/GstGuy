      ...
      <header data-role="Header" className="navigation-container">
        ...
        <div data-role="MobileMenu" className="navigation-mobile-menu">
          <div className="navbar-nav1">
            ...
            <Link   className="navbar-primary-btn button-primary button" to="/gstform"> {props.PrimaryBtn1}</Link>
          ...
          <div className="navbar-social-media">
            ...
            <Link  className="button-primary button navbar-primary-btn1" to="/gstform"> {props.PrimaryBtn}</Link>
