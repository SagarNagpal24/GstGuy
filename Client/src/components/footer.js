...
import whitelogo from "../playground_assets/white-logo.png";
      ...
      <footer className="footer-footer section-container">
        <div className="footer-max-width max-content-container">
          <div className="footer-container">
            <img alt="image" src={whitelogo} className="footer-image" />
          ...
          <div className="footer-links">
            <div className="footer-container2">
              ...
              <Link to="/pricing" className="footer-text07 footer-link">
                Pricing
              </Link>
            </div>
            <div className="footer-container3">
              <span className="footer-text08">Resources</span>
              <span className="footer-link">Reader App</span>
