      ...
      <div className="main">
        <table className="price-table">
          <tbody>
            ...
            {/* <tr>
                <td><a href="#wordpress-asset-updates" className="price-table-help"><i className="far fa-fw fa-question-circle"></i></a> Sites</td>
                <td>1</td>
                <td>1</td>
                <td>1</td>
            </tr>
            <tr>
                <td><a href="#wordpress-core-updates" className="price-table-help"><i className="far fa-fw fa-question-circle"></i></a> Data Retention</td>
                <td>30 Days</td>
                <td>90 Days</td>
                <td>180 Days</td>
            </tr> */}
            ...
            <tr>
                <td><a href="#wordpress-priority-support" className="price-table-help"><i className="far fa-fw fa-question-circle"></i></a> Priority Support</td>
                <td><i className="fas fa-times"></i></td>
                <td><i className="fas fa-times"></i></td>
                <td><i className="fas fa-check"></i></td>
            </tr>
            <tr>
                <td><a href="#wordpress-billing" className="price-table-help"><i className="far fa-fw fa-question-circle"></i></a> Easy Billing + No Contracts</td>
                <td><i className="fas fa-check"></i></td>
                <td><i className="fas fa-check"></i></td>
                <td><i className="fas fa-check"></i></td>
            </tr> */}
