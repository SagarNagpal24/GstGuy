      ...
      <div className="ruby-wrapper">
        ...
        <ul className="ruby-menu">
          ...
          <li><a href="#">Classic</a>
            <ul className="">
              ...
              <li><a href="#">2nd Level #3</a>
                <ul>
                  <li><a href="#"><i className="fa fa-university" aria-hidden="true"></i>3rd Level #1</a>
                    <ul>
                      <li><a href="#">4th Level #1</a></li>
                      <li><a href="#">4th Level #2</a></li>
                    </ul>
                  <span className="ruby-dropdown-toggle"></span></li>
                  <li><a href="#"><i className="fa fa-thumbs-up" aria-hidden="true"></i>3rd Level #2</a></li>
                  <li><a href="#"><i className="fa fa-users" aria-hidden="true"></i>3rd Level #3</a>
                    <ul>
                      <li><a href="#"><i className="fa fa-paper-plane" aria-hidden="true"></i>4th Level #1</a></li>
                      <li><a href="#"><i className="fa fa-print" aria-hidden="true"></i>4th Level #2</a></li>
                      <li><a href="#"><i className="fa fa-shopping-bag" aria-hidden="true"></i>4th Level #3</a></li>
                    </ul>
                  <span className="ruby-dropdown-toggle"></span></li>
                </ul>
              <span className="ruby-dropdown-toggle"></span></li>
            ...
            <div className="ruby-grid ruby-grid-lined">
              <div className="ruby-row">
                ...
                <div className="ruby-col-2 hidden-md">
                  ...
                  <ul>
                    <li><a href="#"><i className="fa fa-motorcycle" aria-hidden="true"></i>Menu Item #1</a></li>
                    <li><a href="#"><i className="fa fa-music" aria-hidden="true"></i>Menu Item #2</a></li>
                    <li><a href="#"><i className="fa fa-shopping-cart" aria-hidden="true"></i>Menu Item #3</a></li>
                    <li><a href="#"><i className="fa fa-sliders" aria-hidden="true"></i>Menu Item #4</a></li>
                    <li><a href="#"><i className="fa fa-search" aria-hidden="true"></i>Menu Item #5</a></li>
                  </ul>
                </div>
                <div className="ruby-col-3 ruby-col-4-md">
                  ...
                  <ul className="ruby-list-with-images">
                    <li><a href="#"><img src="img/c-1.png"/>Menu Item #1</a><span className="ruby-list-desc">Lorem ipsum dolor sit</span></li>
                    <li><a href="#"><img src="img/c-2.png"/>Menu Item #2</a><span className="ruby-list-desc">Lorem ipsum dolor sit</span></li>
                    <li><a href="#"><img src="img/c-3.png"/>Menu Item #3</a><span className="ruby-list-desc">Lorem ipsum dolor sit</span></li>
                  </ul>
                </div>
                <div className="ruby-col-5">
                  ...
                  <div className="ruby-row">
                    <div className="ruby-col-4 ruby-col-6-md">
                      <ul>
                        <li><a href="#"><i className="fa fa-star" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-signal" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-send" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-user" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-thumbs-o-up" aria-hidden="true"></i>Menu Item</a></li>
                      </ul>
                    </div>
                    <div className="ruby-col-4 ruby-col-6-md" style="padding-left:10px">
                      <ul>
                        <li><a href="#"><i className="fa fa-rocket" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-warning" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-upload" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-umbrella" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-trophy" aria-hidden="true"></i>Menu Item</a></li>
                      </ul>
                    </div>
                    <div className="ruby-col-4 hidden-md" style="padding-left:15px">
                      <ul>
                        <li><a href="#"><i className="fa fa-map-o" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-image" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-legal" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-paint-brush" aria-hidden="true"></i>Menu Item</a></li>
                        <li><a href="#"><i className="fa fa-heart" aria-hidden="true"></i>Menu Item</a></li>
                      </ul>
                    </div>
                  </div>
                </div>
            ...
            <div style="height: 269.359px;" className="">
              <ul className="ruby-menu-mega-blog-nav">
                ...
                <li className="ruby-active-menu-item"><a href="#">Blog-4-Column</a>
                  <div className="ruby-grid ruby-grid-lined" style="height: 264.359px;">
                    <div className="ruby-row">
                      <div className="ruby-col-3">
                        <img src="http://brienlabs.com/ruby-mega-menu/img/travel-1.jpg"/>
                        <div className="ruby-c-inline">
                          <span className="ruby-c-category"><a href="#">News / Travel</a></span>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <div className="ruby-c-inline">
                          <span className="ruby-c-category"><a href="#">News / Tech</a></span>
                          <span className="ruby-c-date"><a href="#">05/01/2017</a></span>
                        </div>
                    ...
                    <div className="ruby-row">
                      ...
                      <div className="ruby-col-4">
                        ...
                        <div className="ruby-col-7">
                          ...
                          <span className="ruby-c-category"><a href="#">News / Photography</a></span>
                          <span className="ruby-c-date"><a href="#">05/01/2017</a></span>
                        </div>
                      </div>
                    </div>
                    <div className="ruby-row">
                      ...
                      <div className="ruby-col-4">
                        ...
                        <div className="ruby-col-7">
                          ...
                          <span className="ruby-c-category"><a href="#">News / Life</a></span>
                          <span className="ruby-c-date"><a href="#">05/01/2017</a></span>
                        </div>
                      </div>
                      <div className="ruby-col-4">
                    ...
                    <div className="ruby-row">
                      <div className="ruby-col-6">
                        ...
                        <div className="ruby-col-8">
                          ...
                          <div className="ruby-c-inline">
                            <span className="ruby-c-category"><a href="#"><i className="fa fa-tag" aria-hidden="true"></i> News / Tech</a></span>
                            <span className="ruby-c-date"><a href="#"><i className="fa fa-calendar" aria-hidden="true"></i> 05/01/2017</a></span>
                          </div>
                        </div>
                      </div>
                      <div className="ruby-col-6">
                ...
                <li><a href="#">Blog-Article-List</a>
                  <div className="ruby-grid ruby-grid-lined" style="height: 264.359px;">
                    <div className="ruby-row">
                      <div className="ruby-col-6">
                        <span className="ruby-c-title" style="margin-bottom:15px">POPULAR THREADS</span>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-1.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">An Erupting Volcano And A Meteor Has Created A Fantastic View</a></span></div>
                        </div>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-2.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">Bottle Labels With Short Stories To Be Read Is The New Marketing Era</a></span></div>
                        </div>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-3.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">10+ Stunning Animal Portraits That Has Been Filmed By Polyushko</a></span></div>
                        </div>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-10.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">10 Freaking Facts About Being An airline pilot</a></span></div>
                        </div>
                      </div>
                      <div className="ruby-col-6">
                        <span className="ruby-c-title" style="margin-bottom:15px">MOST COMMENTED</span>
                        <div className="ruby-row">
                          <div className="ruby-col-1"><img src="img/blog-1.jpg"/></div>
                          <div className="ruby-col-11"><span className="ruby-c-title"><a href="#">An Erupting Volcano And A Meteor Has Created A Fantastic View</a></span></div>
                        </div>
          ...
          <li className="ruby-menu-mega-shop"><a href="#">Shop</a>
            <div style="height: 263px;" className="">
              <ul>
                  ...
                  <div className="ruby-grid ruby-grid-lined">
                    <div className="ruby-row">
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style="margin-top: 16px;">EYEWEAR</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style="margin-top: 16px;">JEWELLERY</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style="margin-top: 16px;">WATCHES</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
                      ...
                      <div className="ruby-col-3">
                        ...
                        <h3 className="ruby-list-heading" style="margin-top: 16px;">OTHERS</h3>
                        <ul>
                          <li><a href="#">Menu Item #1</a></li>
                          <li><a href="#">Menu Item #2</a></li>
                          <li><a href="#">Menu Item #3</a></li>
          ...
          <li className="ruby-menu-right"><a href="#">Right</a>
            <ul>
              <li><a href="#">2nd Level #1</a></li>
              <li><a href="#">2nd Level #2</a></li>
              <li className="ruby-open-to-left"><a href="#">2nd Level #3</a>
                <ul>
                  <li className="ruby-open-to-left"><a href="#"><i className="fa fa-university" aria-hidden="true"></i>3rd Level #1</a>
                    <ul>
                      <li><a href="#">4th Level #1</a></li>
                      <li><a href="#">4th Level #2</a></li>
                    </ul>
                  ...
                  <li><a href="#"><i className="fa fa-thumbs-up" aria-hidden="true"></i>3rd Level #2</a></li>
                  <li><a href="#"><i className="fa fa-users" aria-hidden="true"></i>3rd Level #3</a>
                  </li><li><a href="#"><i className="fa fa-file" aria-hidden="true"></i>3rd Level #4</a>
                    <ul>
                      <li><a href="#"><i className="fa fa-paper-plane" aria-hidden="true"></i>4th Level #1</a></li>
                      <li><a href="#"><i className="fa fa-print" aria-hidden="true"></i>4th Level #2</a></li>
                      <li><a href="#"><i className="fa fa-shopping-bag" aria-hidden="true"></i>4th Level #3</a></li>
          ...
          <li className="ruby-menu-right ruby-menu-social"><a href="#"><i className="fa fa-facebook" aria-hidden="true"></i><span>@rubymenu</span></a></li>

          <li className="ruby-menu-right ruby-menu-social"><a href="#"><i className="fa fa-twitter" aria-hidden="true"></i><span>/rubymenu</span></a></li>

          <li className="ruby-menu-right ruby-menu-social ruby-menu-search"><a href="#"><i className="fa fa-search" aria-hidden="true"></i><span><input type="text" name="search" placeholder="Search.."/></span></a></li>
